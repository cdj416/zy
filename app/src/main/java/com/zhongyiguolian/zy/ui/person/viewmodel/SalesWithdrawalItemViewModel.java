 ...
 * @date 2020/12/10
 */
public class SalesWithdrawalItemViewModel extends ItemViewModel<SalesWithdrawalViewModel> {

    public ObservableField<String> entity = new ObservableField<>();

    public SalesWithdrawalItemViewModel(@NonNull SalesWithdrawalViewModel viewModel, String bean) {
        super(viewModel);
        entity.set(bean);
    }
    //条目的点击事件

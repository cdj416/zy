 ...
 * @date 2020/12/10
 */
public class ServiceDetailNewViewModel extends CustomViewModel<MyRepository> {

    /**
     * @param application
     * @param model
     */
    public ServiceDetailNewViewModel(@NonNull Application application, MyRepository model) {
     ...
     * 页面title
     */
    public ObservableField<String> titleName = new ObservableField<>("服务器");

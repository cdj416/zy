...
public class HttpsUtils {
    ...
    private static KeyManager[] prepareKeyManager(InputStream bksFilek, String password){
        try {
            if(bksFilek == null || password == null) return null;
            KeyStore clientKeyStore = KeyStore.getInstance("BKS");
            clientKeyStore.load(bksFilek,password.toCharArray());
